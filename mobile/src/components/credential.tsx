...
export function Credential({ onChangeAvatar, onExpandQRCode, image }: Props) {
  return (
    <View className="w-full self-stretch items-center">
      ...
      <View
        className="bg-black/20 place-self-stretch items-center pb-6 border border-white
      ...
      >
        ...
        {image ? (
          ...
          <TouchableOpacity
            activeOpacity={0.9}
            className="w-35  h-36 rounded-full -mt-24 bg-gray-400 items-center justify-center"
